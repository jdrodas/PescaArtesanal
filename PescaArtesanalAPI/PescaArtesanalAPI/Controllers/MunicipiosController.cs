...
namespace PescaArtesanalAPI.Controllers
{
    ...
    public class MunicipiosController : Controller
    {
        ...
        {
            var losMunicipios = await _municipiosService
                .GetAsync();
        ...
        {
            var unMunicipio = await _municipiosService
                .GetAsync(id);
        ...
        {
            await _municipiosService
                .CreateAsync(unMunicipio);
        ...
        {
            var municipioExistente = await _municipiosService
                .GetAsync(id);
        ...
        [HttpPut]
        public async Task<IActionResult> Update(Municipio unMunicipio)
        {
            var municipioExistente = await _municipiosService
                .GetAsync(unMunicipio.Id!);

            if (municipioExistente is null)
                return NotFound();

            await _municipiosService
                .UpdateAsync(unMunicipio.Id!, unMunicipio);
            return NoContent();
        }
